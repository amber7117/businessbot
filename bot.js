...
addEventListener('fetch', (event) => {
  ...
  \`\`\``;
          ...
          // Remove NASA image fetching functionality
          await sendTelegramMessage(chatId, businessConnectionId, 'NASA image fetching is no longer supported.', null, '5046551865169281494');
